...
- **Before they mark it `done`, offer `/recall <feature>` once**, skippable and never a reason to withhold `done`: it checks the engineer can still explain the code that was built.
